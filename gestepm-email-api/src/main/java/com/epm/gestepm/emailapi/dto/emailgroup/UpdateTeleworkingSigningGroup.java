...
public class UpdateTeleworkingSigningGroup extends EmailGroup {

    private static final String DATE_TIME_FORMAT = "dd/MM/yyyy HH:mm:ss";

    @NotNull
    private Integer teleworkingSigningId;
    ...
    public String getEmailTemplate() {
        return "update-teleworking-signing";
    }

    @Override
    public Map<String, Object> buildVariables() {
        final Map<String, Object> variables = new HashMap<>();
        variables.put("teleworkingSigningId", teleworkingSigningId);
