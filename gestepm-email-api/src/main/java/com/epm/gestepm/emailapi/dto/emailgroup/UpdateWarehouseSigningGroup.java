...
public class UpdateWarehouseSigningGroup extends EmailGroup {

    private static final String DATE_TIME_FORMAT = "dd/MM/yyyy HH:mm:ss";

    @NotNull
    private Integer warehouseSigningId;
    ...
    public String getEmailTemplate() {
        return "update-warehouse-signing";
    }

    @Override
    public Map<String, Object> buildVariables() {
        final Map<String, Object> variables = new HashMap<>();
        variables.put("warehouseSigningId", warehouseSigningId);
