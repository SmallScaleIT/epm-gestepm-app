...
public class UpdateWorkshopSigningGroup extends EmailGroup {

    private static final String DATE_TIME_FORMAT = "dd/MM/yyyy HH:mm:ss";

    @NotNull
    private Integer workshopSigningId;
    ...
    public String getEmailTemplate() {
        return "update-workshop-signing";
    }

    @Override
    public Map<String, Object> buildVariables() {
        final Map<String, Object> variables = new HashMap<>();
        variables.put("workshopSigningId", workshopSigningId);
