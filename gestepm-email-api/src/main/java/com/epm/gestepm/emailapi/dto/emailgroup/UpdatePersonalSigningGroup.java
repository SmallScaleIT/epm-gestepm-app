...
public class UpdatePersonalSigningGroup extends EmailGroup {

    private static final String DATE_TIME_FORMAT = "dd/MM/yyyy HH:mm:ss";

    @NotNull
    private Integer personalSigningId;
    ...
    public String getEmailTemplate() {
        return "update-personal-signing";
    }

    @Override
    public Map<String, Object> buildVariables() {
        final Map<String, Object> variables = new HashMap<>();
        variables.put("personalSigningId", personalSigningId);
