const endpoint = '/v1/shares/programmed';
    ...
    let actions = [
        {
            ...
            permission: 'read_programmed_shares'
        },
        {
            action: 'file-pdf',
            url: '/v1/shares/programmed/{id}/export',
...
function remove(id) {
    ...
    if (confirm(messages.shares.programmed.delete.alert.replace('{0}', id))) {

        showLoading();

        axios.delete('/v1/shares/programmed/' + id).then(() => {
